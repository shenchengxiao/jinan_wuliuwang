    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="ibox-content">
                <div class="row">
                    <div class="col-sm-6">
                        <form class="form-horizontal" id="comp_line_edit_form" >
                            <input type="hidden" name="quId" id="user_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <textarea maxlength="1000" placeholder="公司简介"
                                              ...
                                              name="compIntroduction" id="compIntroduction"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-8">
                                    <button class="btn btn-primary" id="btn_comp_line_edit" type="submit">修改</button>
                                </div>
                            </div>
                        </form>
...
<script src="../../js/companyline/company_line_edit.js"></script>