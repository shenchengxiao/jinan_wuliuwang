...
function addimg(){
	$(".add_step").before(' <div class="active_step"> <img src="../../../static/img/a1.jpg"/><span class="delete_step"></span><textarea class="step_text"  placeholder="请添加描述"></textarea></div>')

	bindListener();
}

function bindListener(){
	$(".delete_step").unbind().click(function(){
		$(this).parent().remove();
	})
}
